...
# ── Per-dataset threshold profiles ────────────────────────────────────────────
# Keyed by data directory name (e.g. "test", "0.1x").
# Tuple order: (gb30, gb45, sv7, disp) — generated by tests/test_thresholds.py.
# Used by tests/test_equivalence.py to pick scale-appropriate thresholds.

THRESHOLD_PROFILES: dict[str, tuple[int, int, int, int]] = {
    # populated by running: python3 tests/test_thresholds.py --data-dir data/<name>
}
